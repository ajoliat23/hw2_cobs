...
const conditionsL = () => {
    return ( 
        ...
        <div class = "termsL">
            ...
            <p>By accepting this agreement you enter into a binding and eternal contract with the ruinous powers to
...
never be quenched. You hereby indemnify Cobs of any harm caused by allowing the fish vessel to
thaw, including but not limited to property damage, incineration, and the formation of gaping maws of
despair on your property.</p>
        <br></br>
        <p>By consuming the fish vessel, you forfeit any rights to the above contracted soul, and agree to render
...
number, and exact second of birth to ensure processing of your cancellation. </p>

      
       
            <h2>Summary of Terms</h2>
            <ul>
                <li>The fish is symbolic of my custodianship of a mortal soul.</li>
                <li>If the fish thaws it will create an all-consuming flame.</li>
                <li>If I eat this fish I am forfeiting my soul to Cob's</li>
            </ul>
    </div>
